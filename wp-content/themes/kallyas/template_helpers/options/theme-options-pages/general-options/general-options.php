...
$admin_options[] = array (
    'slug'        => 'general_options',
    'parent'      => 'general_options',
    "name"        => __( "Disable Trackpad/Magic Mouse Support?", 'zn_framework' ),
    "description" => __( "On *some* Macs the mouse wheel is recognized as a trackpad, therefore if this is disabled, it might not work at all. Use carefully! ", 'zn_framework' ),
...
$admin_options[] = array (
    'slug'        => 'general_options',
    'parent'      => 'general_options',
    "name"        => __( "Enable parallax hack?", 'zn_framework' ),
    "description" => __( "This option should fix the white lines between the parallax sections. Because the smooth scroll is having an elastic effect, it also affects parallax scrolling by creating 'white' lines between sections. This options will simply add a 'bleed' zooming the section's images to overlap each others.", 'zn_framework' ),
    "id"          => "smooth_scroll_parallax",
    "std"         => 'no',
    "options"     => array ( 'yes' => __( "Yes", 'zn_framework' ), 'no' => __( "No", 'zn_framework' ) ),
    "type"        => "zn_radio",
    "class"        => "zn_radio--yesno",
...
$admin_options[] = zn_options_video_link_option( 'https://my.hogash.com/video_category/kallyas-wordpress-theme/#u0uQWA-kJOY', __( "Click here to access the video tutorial for this section's options.", 'zn_framework' ), array(
    'slug'        => 'general_options',
    'parent'      => 'general_options'
));
