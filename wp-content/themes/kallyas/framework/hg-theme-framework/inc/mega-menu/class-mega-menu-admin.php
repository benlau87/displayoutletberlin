	...
	function znfw_add_menu_button_fields( $item_id, $item, $depth, $args ){
		...
		<p class="field-enable-mega-menu description description-wide">
			<label for="enable-mega-menu-<?php echo $item_id; ?>">
				<input id="enable-mega-menu-<?php echo $item_id; ?>" type="checkbox" class="menu-item-checkbox znkl-mega-menu-enable" <?php echo $value; ?> name="<?php echo $key; ?>[<?php echo $item_id; ?>]">
				<?php echo $title; ?>
			</label>
		</p>
