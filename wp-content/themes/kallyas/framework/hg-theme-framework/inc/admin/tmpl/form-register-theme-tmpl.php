		...
		<div class="znfb-col-12">
			<div class="zn-dashRegister-infoList">
				...
				<?php
					...
					$whatIsNededUrl = 'https://my.hogash.com/documentation/how-to-register-kallyas-theme/#what_is_needed';
				...
				<ul>
					...
					<li><?php echo sprintf( __( '<a href="%s" target="_blank">Why do I need to register my theme?</a>', 'zn_framework' ), $whatIsNededUrl ); ?></li>
