				...
				<div class="znfb-row">
					...
					<div class="znfb-col-6">
						<div class="zn-lead-text ">
							...
							<ul>
								<li><a href="<?php echo admin_url( 'admin.php?page=zn_tp_general_options' ); ?>" target="_blank"><?php echo ZNHGTFW()->getThemeName(); ?> General Options</a> </li>
								<li><a href="<?php echo admin_url( 'admin.php?page=zn_tp_general_options#header_options' ); ?>" target="_blank">Change Header settings</a> ( <?php echo ZNHGTFW()->getThemeName(); ?> options > General settings > Header Options )</li>
								<li><a href="<?php echo admin_url( 'admin.php?page=zn_tp_color_options' ); ?>" target="_blank">Change Site Color settings</a> ( <?php echo ZNHGTFW()->getThemeName(); ?> options > Color Options )</li>
