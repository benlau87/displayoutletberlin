	...
	function __validateRequest()
	{
		...
		if( ! empty( $apiKey ) )
		{
			...
			if( isset($response['success']) && $response['success']){
				...
				$hogashUrl = 'http://my.hogash.com/';
				return array(
					'success' => true,
					'data' => sprintf( __('Thank you! Your theme is now connected with the <a href="%s" target="_blank">Hogash Dashboard</a>.', 'zn_framework'), $hogashUrl )
				);
			}
			else {
				return array(
