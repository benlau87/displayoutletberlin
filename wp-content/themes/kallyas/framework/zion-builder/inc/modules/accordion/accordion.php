	...
	function options()
	{
		...
		$options = array(
			...
			'help' => znpb_get_helptab( array(
				'video'   => 'https://my.hogash.com/video_category/kallyas-wordpress-theme/#gIrgHl-BrLQ',
				'docs'    => 'https://my.hogash.com/documentation/accordion/',
				'copy'    => $uid,
				'general' => true,
				'custom_id' => true,
			)),
				...
				if ( isset ( $options['accordion_single'] ) && is_array( $options['accordion_single'] ) ) {
					foreach ( $options['accordion_single'] as $acc )
					{
						...
						echo '<div class="panel zn-accordion-accGroup">';
							...
							echo '<div id="acc' . $uniq . '' . $acc_id . '" class="zn-accordion-panelCollapse collapse ' . $colapsed .'">';
