	...
	function options()
	{
		...
		return array (
			...
			'help' => znpb_get_helptab( array(
				'video'   => 'https://my.hogash.com/video_category/kallyas-wordpress-theme/#Hgwzjxw7ng4',
				'docs'    => 'https://my.hogash.com/documentation/ios-slider/',
				'copy'    => $uid,
				'general' => true,
				'custom_id' => true,
			)),
				...
				if ( !empty( $slides ) ) {
					foreach ( $slides as $i => $slide ) {
						 ...
						 */
							...
							$media_markup .= WpkPageHelper::zn_klvideo(array(
								'video_class'            => 'iosslider-video',
								'source_type'            => $slideType,
								'source_vd_yt'           => isset($slide['vd_yt']) ? $slide['vd_yt'] : '',
								'source_vd_vm'           => isset($slide['vd_vm']) ? $slide['vd_vm'] : '',
